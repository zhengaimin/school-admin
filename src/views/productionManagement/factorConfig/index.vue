<template>
  <div class="process-content">
      ...
      <div class="fossil-fuel">
        ...
        <div class="table-box">
          <div class="btn-box">
            <span> 因子库列表（使用中）</span>
            <div>
              <!-- <el-button type="primary" class="search-btn" @click="addMethod"> 新增企业因子 </el-button> -->
            </div>
          </div>
          <div class="table-list">
            <el-table style="width: 100%; height: calc(100% - 50px)" class="my-custom-table" :data="tableData">
              ...
              <el-table-column label="使用中的因子值" align="left" width="240">
                <template #default="{ row }">
                  <div v-if="!row.data_json">
              ...
              <el-table-column label="操作" align="center" width="180" fixed="right">
                <template #default="scope">
                  <div class="table-btn">
                    <div @click="getHistory(scope.row)">因子历史数据</div>
          ...
          <el-row>
            <el-col :span="18">
              <el-form-item label="品种名称" prop="variety_name">
                <el-input v-model="linkRuleForm.variety_name" :disabled="linkRuleForm.id"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
          ...
          <el-row>
            <el-col :span="23">
              <el-form-item label="因子来源" prop="source_id">
                <el-select v-model="linkRuleForm.source_id" :disabled="linkRuleForm.id">
    ...
    <el-dialog v-model="historyDialog" :close-on-click-modal="false" title="因子历史数据" :width="900">
      <div style="padding-left: 20px">
        <el-table :data="historyList" border height="650px">
...
export default {
  ...
  methods: {
    ...
    factor_list() {
      ...
      let str = `is_used=1&model_type=1&page=${this.page}&page_size=${this.page_size}&emission_process_type=${this.filterForm.emission_process_type}&source_ids=${source_ids_str}&variety_name=${this.filterForm.variety_name}`;
    ...
    confirmAdd() {
      this.$refs.linkFormRef.validate(valid => {
        if (valid) {
          ...
          if (this.linkRuleForm.id) {
            let params = {
              industry_varieties_id: this.linkRuleForm.id,
