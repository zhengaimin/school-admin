    ...
    <div class="right" ref="refRight">
      <div class="fossil-fuel">
        <div class="filter-box">
          ...
          <label>因子来源</label>
          <el-select style="width: 200px" multiple collapse-tags v-model="filterForm.source_ids" @focus="focusSource">
        ...
        <div class="table-box">
          <div class="btn-box">
            ...
            <div>
              ...
              <el-button :disabled="!isEdit" type="primary" class="search-btn" @click="moveConfirm"> 同步到企业因子库 </el-button>
            </div>
          </div>
          <div class="table-list">
            ...
            >
              ...
              <el-table-column v-if="false" label="操作" align="center" width="130" fixed="right">
