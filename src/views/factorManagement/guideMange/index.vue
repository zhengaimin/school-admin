    ...
    <div class="table-box">
      ...
      <div class="table-list">
        <el-table style="width: 100%; height: calc(100% - 50px)" class="my-custom-table" :data="tableData">
          ...
          <el-table-column v-if="isEdit && false" label="操作" align="center" width="130" fixed="right">
...
export default {
  ...
  methods: {
    ...
    // 获取列表
    factor_source_list() {
      let str = `model_type=1&page=${this.page}&page_size=${this.page_size}&name=${this.filterForm.name}`;
