<template>
  <div class="sourceTrendChart">
    ...
    <div class="grid-background" id="sourceTrendChart" style="width: 100%; height: calc(100% - 43px)"></div>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    initEchart(sourceList) {
      ...
      this.myChart = echarts.init(document.getElementById("sourceTrendChart"));
