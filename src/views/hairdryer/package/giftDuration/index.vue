...
const columns: ColumnProps<GiftRow>[] = [
  ...
  { prop: "studentName", label: "学生", minWidth: 140 },
  { prop: "totalMinutes", label: "总赠送分钟数", width: 140 },
  { prop: "usedMinutes", label: "已使用分钟数", width: 140 },
  { prop: "remainingMinutes", label: "剩余分钟数", width: 120 },
  { prop: "startDate", label: "生效时间", width: 180 },
  { prop: "expireDate", label: "过期时间", width: 180 },
  {
    prop: "status",
    label: "状态",
    width: 100,
