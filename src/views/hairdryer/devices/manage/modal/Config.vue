...
/** 获取设备功能配置 */
async function axiosGetDeviceFeatureConfigApi(id: number): Promise<void> {
  try {
...
/** 更新设备功能配置 */
async function axiosPutDeviceFeatureConfigApi(id: number) {
  try {
    const result = await updateDeviceFeatureConfigApi(id, {
      config: {
    ...
    console.error("axiosPutDeviceFeatureConfigApi:", error);
...
async function handleSave() {
  ...
  loading.value = true;
  try {
    const result = await axiosPutDeviceFeatureConfigApi(deviceId.value);
