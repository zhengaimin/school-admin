...
import { getPackageRecordsApi, getGradesApi, getDepartmentsListApi, getClassesListApi } from "@/api/modules";
...
/** 查看详情 */
const handleShowDetail = (row: PackageRecord.IPackageRecordItem) => {
