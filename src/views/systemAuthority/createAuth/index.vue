  ...
  <div class="table-box">
    ...
    <div class="table-list">
      <el-table class="my-custom-table" :data="carbonCk_list">
        ...
        <el-table-column label="权限" prop="name" align="center"> </el-table-column>
        <el-table-column label="标志" prop="email" align="center"> </el-table-column>
        <el-table-column label="方法" align="center"> </el-table-column>
        <el-table-column label="路径" align="center"> </el-table-column>
    ...
    <!-- 新增 -->
    <el-dialog v-model="dialogVisibleAdd" :close-on-click-modal="false" title="新增权限" width="700">
...
export default {
  ...
  methods: {
    formInfo() {
      formInfo({ key: "addauthority" }).then(res => {
