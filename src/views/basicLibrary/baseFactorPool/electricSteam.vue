    ...
    <div class="table-box">
      <div class="btn-box">
        ...
        <div>
          ...
          <el-button type="primary" class="search-btn" @click="steam_choice"> 复制到企业因子库 </el-button>
        </div>
      </div>
...
import { steam_add, steam_list, steam_delete, steam_update, steam_choice } from "@/api/modules/basicLibrary.js";
export default {
  name: "FossilFuel",
  props: {
    nodeObj: {
