  ...
  <div class="table-box">
    ...
    <div class="table-list">
      <el-table class="my-custom-table" :data="carbonCk_list">
        <el-table-column label="消费人员" prop="a"> </el-table-column>
        <el-table-column label="消费金额（元）" prop="b"> </el-table-column>
        <el-table-column label="消费时间" prop="c"> </el-table-column>
        <el-table-column label="消费单号" prop="d"> </el-table-column>
      ...
      carbonCk_list: [
        {
          ...
          a: "同学一",
          b: "25",
          c: "2022-02-01 10:00:00",
          d: "346578904567890897"
        }
      ],
      total: 0,
      page: 1,
