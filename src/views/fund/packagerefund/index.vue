...
export default {
  ...
  methods: {
    ...
    exportInfo() {
      ...
      this.filterForm.startDate = this.filterForm.startDate ? this.filterForm.startDate : "";
      this.filterForm.endDate = this.filterForm.endDate ? this.filterForm.endDate : "";
      let params = `schoolId=${this.schoolId}&refundType=PACKAGE&studentKeyword=${this.filterForm.studentKeyword}&status=${status}&startDate=${this.filterForm.startDate}&endDate=${this.filterForm.endDate}&gradeId=${gradeId}&departmentId=${departmentId}&classId=${classId}`;
    ...
    confirmexport() {
      ...
      this.filterForm.startDate = this.filterForm.startDate ? this.filterForm.startDate : "";
      this.filterForm.endDate = this.filterForm.endDate ? this.filterForm.endDate : "";
      let url = `${this.exportmessageUrl}?page=${this.pageInfo}&pageSize=${this.pageSizeInfo}&schoolId=${this.schoolId}&refundType=PACKAGE&status=${status}&startDate=${this.filterForm.startDate}&endDate=${this.filterForm.endDate}&gradeId=${gradeId}&departmentId=${departmentId}&classId=${classId}`;
      ElNotification({
        title: "提示",
        message: "数据导出中，请稍后",
        type: "success",
