<script setup lang="ts" name="videoRateSchoolCallForm">
...
import { getSchoolCallRateApi, putSchoolCallRateApi } from "@/api/modules";
...
const fetchData = async (): Promise<void> => {
  ...
  loading.value = true;
  try {
    const result = await getSchoolCallRateApi(Number(props.schoolId));
...
const handleSubmit = async (): Promise<void> => {
  ...
  try {
    await putSchoolCallRateApi(Number(props.schoolId), {
      rate: form.rate,
